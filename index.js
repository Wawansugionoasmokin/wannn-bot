...
const config = {
    A187: 'Ridwan-bot', // TOBAT SU ASU
    instagram: 'https://instagram.com/mridwanalb_', // INFO JANGAN DI UBAH
    nomer: 'wa.me/6285718038695', // INFO SU JNGAN DI UBAH
    youtube: 'MHMMD RIDWAN', // KINTIL
    whatsapp: 'https://chat.whatsapp.com/Fr81blWzHF0LCUd1vYxqll', // BABI
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285718038695@s.whatsapp.net"] // replace this with your number
              ...
              costum('Ini', '6282387804410@s.whatsapp.com')
				...
				case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `❮ 𝙋𝙀𝙎𝘼𝙉 𝘽𝙍𝙊𝘼𝘿𝘾𝘼𝙎𝙏 👾𝗥𝗜𝗗𝗪𝗔𝗡 𝗕𝗢𝗧👾 ❯\n\n${body.slice(4)}`})
						}
						reply('𝙨𝙪𝙘𝙘𝙚𝙨𝙨 𝙗𝙧𝙤𝙖𝙙𝙘𝙖𝙨𝙩 ')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `❮ 𝙋𝙀𝙎𝘼𝙉 𝘽𝙍𝙊𝘼𝘿𝘾𝘼𝙎𝙏 👾𝗥𝗜𝗗𝗪𝗔𝗡 𝗕𝗢𝗧👾 ❯\n\n${body.slice(4)}`)
						}
						reply('𝙨𝙪𝙘𝙘𝙚𝙨𝙨 𝙗𝙧𝙤𝙖𝙙𝙘𝙖𝙨𝙩 ')
					}
					break
       ...
       client.sendMessage(from, '𝗧𝘂𝗵 𝗱𝗮𝗵 𝗮𝗸𝘂 𝗸𝗮𝘀𝗶𝗵 𝗻𝗼𝗺𝗲𝗿 𝗖𝗢 👾𝗥𝗜𝗗𝗪𝗔𝗡 𝗕𝗢𝗧👾,𝗝𝗔𝗡𝗚𝗔𝗡 𝗟𝗨𝗣𝗔 𝗗𝗜 𝗦𝗔𝗩𝗘 𝗘𝗔 ><',MessageType.text, { quoted: mek} )
           break    
           case 'demote':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
				...
				case 'nsfw':
					...
					if (Number(args[0]) === 1) {
						...
						reply('𝗸𝗲𝘁𝗶𝗸 𝗽𝗲𝗿𝗶??𝘁𝗮𝗵 𝟭 𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗻𝗴𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻, 𝟬 𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗻𝗼𝗻𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻\n𝗰𝗼𝗻𝘁𝗼𝗵: ${prefix}𝗻𝘀𝗳𝘄 𝟭')
					}
					break
				case 'welcome':
					if (!isGroup) return reply(mess.only.group)
...
s.video, video, {quoted: mek, caption: res.teks.trim()})
						}).catch(err => {
							reply(err)
						})
					} else {
...
*ANAK ANJING MAU NGAPAIN?
*HARGAIN CREATOR ASLINYA BOSQUE
*GUA SUSAH PAYAH BUAT,KALIAN CUMAN MOD